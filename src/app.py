...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practice and matches competing against other schools",
    ...
    # Artistic activities
    "Art Club": {
        "description": "Painting, drawing, and mixed media workshops and exhibitions",
    ...
    "Science Club": {
        "description": "Hands-on experiments, guest speakers, and science fair projects",
